...
public class wierdgame1 {																				//class declaration
												/*hero data variables*/
		...
		static int MonstHlth = 100;																	//declare variable for monster's health and initializeit to 100
		static int MonstAtk = 15;			
	...
	public static void main(String[] args) {														//begin main method
		...
		heroCreationMethod();																		//call hero creation method
														/*monster data variables*/
